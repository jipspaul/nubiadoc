...
| [`17-benchmark-dental-pilot.md`](./17-benchmark-dental-pilot.md) | **Benchmark** Dental Pilot vs Nubia (démo vidéo 09/2026, vérifié contre le code) : matrice par domaine, ce qu'on a de plus, ce qui manque par effort, plan pour la parité puis faire mieux, impacts sur la roadmap du 16/09. |
