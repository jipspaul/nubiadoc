...
test('le formulaire /appointments/patch-id est visible avec les champs requis', async ({ page }) => {
  await page.goto('/appointments/patch-id');
...
test('happy path => PATCH retourne 200 avec appointment_id', async ({ page }) => {
