...
test('le formulaire /scheduling/appointment-directions est visible avec les champs requis', async ({ page }) => {
  await page.goto('/scheduling/appointment-directions');
...
test('happy path => GET directions retourne 200, deeplink cliquable visible', async ({ page }) => {
