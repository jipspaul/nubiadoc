...
| /consultation | praticien | 2026-07-01 | page.goto: browser/context closed pendant le run QA (pas d'exception app — ConsultationCliniqueBloc couvre tous les states avec try/catch + SafeEmitMixin, ConsultationCliniqueBody gère Initial/Loading/Loaded/Error/Completed/HistoriqueLoaded, route wrappée en BlocProvider, tests widget ajoutés pour tous les states) | faux positif — ferme #3137 |
