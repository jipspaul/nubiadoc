...
| B (invitation secretariat) | secretariat | 2026-07-06T16:11:23.185Z | OK | re-reconfirmé — fix PR #3209 tient toujours (400 invitation_invalid, "Invitation invalide" affiché) ; le run 2026-07-06 (#3398) a rapporté "message shown=false" à l'étape 2, mais c'est le même piège harness que la checkbox CGU patient (voir notes méthodologiques) — vérifié de bout en bout (widget + AuthRepositoryImpl → Dio 400 → InvalidInviteFailure → écran "Invitation invalide") sans reproduire de bug |
