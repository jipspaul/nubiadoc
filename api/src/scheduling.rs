...
/// Corps de `POST /v1/cabinet/slots` (ancienne route, remplacée par `cabinet::create_slot`).
#[allow(dead_code)]
#[derive(Deserialize)]
...
/// `POST /v1/cabinet/slots` — ancienne implémentation, remplacée par `cabinet::create_slot`.
///
/// Conservée pour ne pas casser les autres exports de ce module.
#[allow(dead_code)]
