...
use crate::{
    ...
    medical_questionnaire, medical_record, orthodontics, patient_detail, patient_merge,
    patient_tags, periodontal_chart, treatment_phases, treatment_plans, AppState,
};
