...
INSERT INTO cabinet_membership (id, cabinet_id, user_id, role) VALUES
  ...
  ('b0000000-0000-0000-0000-0000000000b3','11111111-1111-1111-1111-111111111111','a0000000-0000-0000-0000-0000000000a3','secretary'),
  ('b0000000-0000-0000-0000-0000000000b4','11111111-1111-1111-1111-111111111111','a0000000-0000-0000-0000-0000000000a4','admin')
ON CONFLICT (id) DO NOTHING;
