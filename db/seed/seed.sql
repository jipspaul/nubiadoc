...
INSERT INTO conversation (id, cabinet_id, patient_id, scope, status) VALUES
  ...
  -- scope=clinical : fil médical Marc Dubois ↔ Dr Marin (R.4127-72 — secrétariat exclu)
  ('c1000000-0000-0000-0000-000000000004','11111111-1111-1111-1111-111111111111','d0000000-0000-0000-0000-0000000000d1','clinical','open'),
  -- scope=admin : fil administratif Marc Dubois ↔ Sonia (devis, RDV)
  ('c1000000-0000-0000-0000-000000000005','11111111-1111-1111-1111-111111111111','d0000000-0000-0000-0000-0000000000d1','admin','open')
ON CONFLICT (id) DO NOTHING;
INSERT INTO message (id, cabinet_id, conversation_id, sender_kind, sender_id, body_ciphertext, body_key_ref, triage_flag, triage_reason, created_at) VALUES
  ...
  -- message fil clinical (praticien → patient, contenu médical chiffré)
  ('c2000000-0000-0000-0000-000000000004','11111111-1111-1111-1111-111111111111','c1000000-0000-0000-0000-000000000004','practitioner','a0000000-0000-0000-0000-0000000000a1','\x53454544','SEED_PLACEHOLDER','normal',NULL,'2026-06-03 09:50+00'),
  -- message fil admin (secrétariat → patient, contenu administratif chiffré)
  ('c2000000-0000-0000-0000-000000000005','11111111-1111-1111-1111-111111111111','c1000000-0000-0000-0000-000000000005','secretary','a0000000-0000-0000-0000-0000000000a3','\x53454544','SEED_PLACEHOLDER','normal',NULL,'2026-06-03 10:15+00')
ON CONFLICT (id) DO NOTHING;
