...
| `nubia-web`    | 8081/8082/8083 | nginx servant les 3 bundles Flutter web        |

Fronts : `8081` patient · `8082` praticien · `8083` secrétariat.
...
- Les 3 apps Flutter sont buildées en **web** (statique). Le cache Drift utilise
...
| `nginx.conf`                    | Sert les 3 bundles Flutter (8081/8082/8083)          |
