...
void main() {
  ...
  group('NotificationsPage — état Empty (Loaded vide)', () {
  ...
  group('NotificationsPage — état Loaded (avec notifications)', () {
    testWidgets('affiche la liste quand des notifications sont chargées',
        (tester) async {
      final bloc = MockNotificationsBloc();
    ...
    testWidgets('un tap dispatche NotificationMarkReadRequested',
        (tester) async {
      final bloc = MockNotificationsBloc();
      when(() => bloc.state)
  ...
  group('NotificationsPage — état Error', () {
    testWidgets('affiche NubiaErrorWidget avec message en état Error',
        (tester) async {
      final bloc = MockNotificationsBloc();
      when(() => bloc.state)
