...
///
/// Les 3 droits proposés (rendez-vous, documents, messages) correspondent
/// tous à des valeurs acceptées par l'API (`ACCESS_REQUEST_SCOPE_VALUES`,
/// `api/src/auth/mod.rs`) — « messages » en fait partie (#7708).
