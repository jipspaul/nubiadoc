    ...
    return ListView(
      ...
      children: [
        ...
        _SectionLabel(
          ...
          onActionTap: () => context.go(AppRouter.profileNotifications),
        ),
        const SizedBox(height: 12),
        NubiaCard(
          child: Column(
          ...
          child: Column(
            children: [
              ListRow(
                ...
                onTap: () => context.go(AppRouter.financial),
              ),
              ListRow(
                ...
                onTap: () => context.go(AppRouter.coverageSetup),
              ),
              ListRow(
                ...
                onTap: () => context.go(AppRouter.profileReferringDoctor),
              ),
              ListRow(
              ...
              ListRow(
                ...
                onTap: () => context.go(AppRouter.profileConsents),
              ),
              ListRow(
                ...
                onTap: () => context.go(AppRouter.implantPassport),
              ),
              ListRow(
        ...
        if (kDebugMode) ...[
          ...
          SizedBox(
            ...
            child: NubiaButton(
              ...
              onPressed: () => context.go('/a2ui-demo'),
            ),
          ),
        ],
        const SizedBox(height: 24),
