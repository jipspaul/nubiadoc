...
import 'package:app_secretariat/features/notification_prefs/notification_prefs_cubit.dart';
import 'package:app_secretariat/features/notification_prefs/notification_prefs_page.dart';
...
void main() {
  ...
  testWidgets(
      'affiche les 4 catégories pertinentes pour le rôle secrétariat (#6341)',
      (tester) async {
  ...
  testWidgets(
      'toggle push messagerie déclenche un PATCH optimiste avec la bonne valeur',
      (tester) async {
    ...
    final toggleFinder = find.byKey(const Key('notif_push_messagerie'));
    ...
    expect(captured.pushMessagerie, isFalse);
