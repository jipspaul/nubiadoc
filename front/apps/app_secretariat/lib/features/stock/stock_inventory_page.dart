...
import 'stock_locations_page.dart';
  ...
  void _onLocations() {
    Navigator.of(context).push(MaterialPageRoute<void>(
      builder: (_) => BlocProvider(
        create: (_) => GetIt.instance<StockLocationsBloc>(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            key: const Key('stock_locations_button'),
            tooltip: 'Stock par salle',
            icon: const Icon(Icons.meeting_room_outlined),
            onPressed: _onLocations,
          ),
          IconButton(
            key: const Key('stock_import_button'),
            tooltip: 'Import CSV',
