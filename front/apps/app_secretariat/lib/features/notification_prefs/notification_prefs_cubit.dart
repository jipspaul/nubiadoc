...
/// Cubit des préférences de notification pro (rôle secrétariat), même
/// contrat `GET/PATCH /v1/me/notification-preferences` que côté pharmacie
/// (#6341 — jusqu'ici seule l'app pharmacie exposait un écran, secrétariat
/// n'avait aucun contrôle sur ses 6 opt-in push).
