...
/// Timeline du bloc « Suivi » du volet détail devis (#7467). Chargement
/// indépendant de [DevisBloc] — même découpage que
/// `InvoiceReminderCubit`/`ExpiringQuotesSummaryCubit`.
