...
import '../features/dashboard/dashboard_layout_cubit.dart';
...
void registerPro(GetIt gi) {
  ...
  gi.registerFactory<DashboardLayoutCubit>(
    () => DashboardLayoutCubit(
      get: gi<GetDashboardLayoutUseCase>(),
      update: gi<UpdateDashboardLayoutUseCase>(),
    ),
  );
  ...
  gi.registerFactory<QuoteDocumentsCubit>(
    () => QuoteDocumentsCubit(
      listAttachments: gi<ListQuoteAttachmentsUseCase>(),
      createAttachment: gi<CreateQuoteAttachmentUseCase>(),
      deleteAttachment: gi<DeleteQuoteAttachmentUseCase>(),
      getAttestation: gi<GetQuoteAttestationUseCase>(),
  ...
  gi.registerFactory<LabWorkOrdersBloc>(
    () => LabWorkOrdersBloc(
