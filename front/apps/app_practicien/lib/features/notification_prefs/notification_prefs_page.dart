...
/// pertinente pour le rôle praticien, et un switch e-mail en plus pour les
        ...
        if (state is NotificationPrefsLoaded) {
          ...
          return ListView(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _CategoryCard(
                cardKey: const Key('notif_block_labo'),
                icon: Icons.science_outlined,
                title: 'Travaux de laboratoire',
                inAppSubtitle: 'Travaux prothétiques envoyés ou retournés',
                inAppKey: const Key('notif_inapp_labo'),
                inAppValue: p.inappLabo,
                onInAppChanged:
                    locked ? null : (v) => cubit.save(p.copyWith(inappLabo: v)),
                pushKey: const Key('notif_push_labo'),
                pushValue: p.pushLabo,
                onPushChanged:
                    locked ? null : (v) => cubit.save(p.copyWith(pushLabo: v)),
              ),
              const SizedBox(height: 16),
              _CategoryCard(
