...
/// détail d'une facture (devis signé échu) côté praticien — jumeau de
/// `InvoiceReminderCubit` dans app_secretariat (pas de package partagé pour
/// les cubits d'écran, cf. `DevisBloc` déjà dupliqué par app).
