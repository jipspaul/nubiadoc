...
class CabinetAgendaRepositoryImpl implements CabinetAgendaRepository {
  ...
  @override
  Future<Either<Failure, List<CabinetPractitioner>>> listPractitioners() async {
    try {
      final practitioners = await _api.listPractitioners();
      ...
      return Left(ServerFailure(
        message: 'Impossible de charger les praticiens.',
        statusCode: e.response?.statusCode,
      ));
    } catch (e) {
      return const Left(ParseFailure());
