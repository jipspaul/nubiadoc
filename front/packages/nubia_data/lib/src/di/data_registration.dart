...
import '../remote/consultation_cr/consultation_cr_api.dart';
...
import '../repositories/consultation_cr_repository_impl.dart';
...
void _registerClinical(GetIt gi) {
  gi
    ...
    ..registerLazySingleton<ConsultationCrApi>(() => ConsultationCrApi(gi()))
    ...
    ..registerLazySingleton<ConsultationCrRepository>(
      () => ConsultationCrRepositoryImpl(gi()),
    )
    ...
    ..registerFactory(() => GetConsultationCrUseCase(gi()))
    ..registerFactory(() => SaveConsultationCrUseCase(gi()))
    ..registerFactory(() => FinalizeConsultationCrUseCase(gi()))
...
void _registerPro(GetIt gi, {bool includeClinical = true}) {
  gi
    ...
    ..registerLazySingleton<PeriodontalChartApi>(
      () => PeriodontalChartApi(gi()),
    )
    ...
    ..registerLazySingleton<CabinetOpportunitiesApi>(
      () => CabinetOpportunitiesApi(gi()),
    )
    ..registerLazySingleton<CabinetPayoutsApi>(
      () => CabinetPayoutsApi(gi()),
    )
    ..registerLazySingleton<CashCollectionApi>(
      () => CashCollectionApi(gi()),
    )
    ...
    ..registerLazySingleton<PeriodontalChartRepository>(
      () => PeriodontalChartRepositoryImpl(gi()),
    )
    ...
    ..registerLazySingleton<CabinetOpportunitiesRepository>(
      () => CabinetOpportunitiesRepositoryImpl(gi()),
    )
    ..registerLazySingleton<CabinetPayoutsRepository>(
      () => CabinetPayoutsRepositoryImpl(gi()),
    )
    ..registerLazySingleton<CashCollectionRepository>(
      () => CashCollectionRepositoryImpl(gi()),
    )
  ...
  gi
    ...
    ..registerFactory(() => CabinetCheckinAppointmentUseCase(gi()))
    ..registerFactory(() => CancelCabinetAppointmentUseCase(gi()))
    ...
    ..registerFactory(() => FlagPayoutToAccountantUseCase(gi()))
    ..registerFactory(() => GetCabinetBillingStatsUseCase(gi()))
    ..registerFactory(() => GetCabinetLabStatsUseCase(gi()))
