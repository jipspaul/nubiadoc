...
abstract class ConsultationRepository {
  ...
  Future<Either<Failure, ConsultationContext>> create(ConsultationContext consultation);
  Future<Either<Failure, ConsultationContext>> update(ConsultationContext consultation);
}
